...
import com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Owner;
...
import com.example.dfrolov.allureandroidjava8.allure_implementation.allure.util.ResultsUtils;
import com.example.dfrolov.allureandroidjava8.allure_implementation.model_pojo.Label;
...
import static com.example.dfrolov.allureandroidjava8.allure_implementation.allure.util.ResultsUtils.getHostName;
...
import static com.example.dfrolov.allureandroidjava8.allure_implementation.allure.util.ResultsUtils.getThreadName;
...
public class AllureJunit4 extends RunListener {
    ...
    private Optional<String> getDescription(final Description result) {
        return Optional.ofNullable(result.getAnnotation(com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Description.class))
                .map(com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Description::value);
    }

    private List<com.example.dfrolov.allureandroidjava8.allure_implementation.model_pojo.Link> getLinks(final Description result) {
        return Stream.of(
                getAnnotationsOnClass(result, com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Link.class).stream().map(ResultsUtils::createLink),
                getAnnotationsOnMethod(result, com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Link.class).stream().map(ResultsUtils::createLink),
                getAnnotationsOnClass(result, com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Issue.class).stream().map(ResultsUtils::createLink),
                getAnnotationsOnMethod(result, com.example.dfrolov.allureandroidjava8.allure_implementation.allure.Issue.class).stream().map(ResultsUtils::createLink),
                getAnnotationsOnClass(result, com.example.dfrolov.allureandroidjava8.allure_implementation.allure.TmsLink.class).stream().map(ResultsUtils::createLink),
                getAnnotationsOnMethod(result, com.example.dfrolov.allureandroidjava8.allure_implementation.allure.TmsLink.class).stream().map(ResultsUtils::createLink)
